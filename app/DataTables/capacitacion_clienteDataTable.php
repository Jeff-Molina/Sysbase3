...
class capacitacion_clienteDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ->eloquent($query)
            ->addColumn('action', function(capacitacion_cliente $capacitacionCliente){
                $id = $capacitacionCliente->id;
                return view('capacitacion_clientes.datatables_actions',compact('capacitacionCliente','id'));
            })
            ->editColumn('id',function (capacitacion_cliente $capacitacionCliente){
     ...
     *
     * @param \App\Models\capacitacion_cliente $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(capacitacion_cliente $model)
    {
